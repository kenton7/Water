...
struct K {
    static let weightSegue = "SelectWeight"
    static let activityLevelMan = "ActivityLevelMan"
    static let activityLevelWoman = "ActivityLevelWoman"
    ...
    static let basicAnimation = "strokeEnd"
